...
BOX_LONG_Z=2./3. #(for xy=12 and z=8) #1./2. #(for xy=12 and z=6) #4./3.(for xy=6 and z=8) #1./3. #2./5. #For LBox_xy=6 and LBox_z=2 -> 1./3. # (z direction only H wide) (if shearing box is 6H, then 1/3 = 2, so 1H above and below)
