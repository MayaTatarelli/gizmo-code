...
//EJL (May 3rd 2020); debugging; vphi of grains not quite right near the right edge
//            if( (P[i].Pos[0]-boxHalf_X)/boxHalf_X < 2./3. )
#endif
...
#ifdef PEBBLE_ACCRETION_TESTPROBLEM
//            if( (P[i].Pos[0]-boxHalf_X)/boxHalf_X > 2./3. ) {delta_mom[0]=delta_mom[1]=delta_mom[2]=delta_egy=0;}
#endif
